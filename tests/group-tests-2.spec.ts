...
test.describe("Login", () => {
  test("Test 1 - Login successfully with valid username and password @login @positive", async ({ page }) => {
  ...
  test("Test 2 - Show alert message when user enter invalid password @login @negative", async ({ page }) => {
    let username = "Admin";
